...
export function renderNavbar() {
  ...
  navbarContainer.innerHTML = `
    <nav class="navbar navbar-expand-lg bg-body-tertiary shadow-sm">
      <div class="container">
        <a class="navbar-brand fw-bold" href="${rootUrl}index.html">Fake Store</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ms-auto align-items-center">
            <li class="nav-item">
                <a class="nav-link" href="${rootUrl}index.html">Home</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="${rootUrl}views/products.html">Products</a>
            </li>
            <li class="nav-item">
